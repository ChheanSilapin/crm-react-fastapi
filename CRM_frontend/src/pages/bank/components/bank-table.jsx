...
import { CalendarIcon, FileEditIcon, PlusCircleIcon, Trash2 } from "lucide-react";
                                ...
                                <TableRow key={bank.bank_id}>
                                    <TableCell className="pl-6">
                                        <Avatar className="h-10 w-10 rounded-md border bg-background shadow-sm">
                                            <AvatarImage src={bank.logo} alt={bank.bank_name} className="object-contain p-1" />
                                            <AvatarFallback className="rounded-md bg-primary/5 text-primary text-xs font-semibold">
