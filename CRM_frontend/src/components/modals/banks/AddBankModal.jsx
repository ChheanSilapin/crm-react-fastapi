        ...
        <div className="px-4 pb-4 pt-4 sm:px-6 sm:pb-6 sm:pt-6 md:px-8 md:pb-8 md:pt-8">
          <div className="mb-6">
            ...
            <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
              Register a new banking partner in the system
            </p>
          </div>
          ...
          <div className="flex items-center justify-end space-x-3 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700 mt-4 sm:mt-6">
            ...
            <button
              type="submit"
              form="bank-form"
              className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200"
            >
              Add Bank
            </button>
          </div>
